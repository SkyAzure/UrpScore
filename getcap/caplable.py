...
class Example(QWidget):
    ...
    def initUI(self):
        ...
        self.setWindowIcon(QIcon('/Users/sky/code/python/tust/UrpScore/getcap/logo.png'))
        self.show()
    ...
    def getcap(self):
        ...
        #self.captextstr += captext
        #self.captextlist =list(self.captextstr)
        #self.captextlist =sorted(set(self.captextlist))
        #print(self.captextlist)
        ...
        NewPath = os.path.abspath(os.path.join(os.getcwd(), "../..")) + "/capfin/" + captext + ".jpg"
        try:
